...
const Womenlist = () => {
  ...
  return (
    ...
    >
      ...
      >
        Women’s Salon Price Card
      </h2>

      {/* RESPONSIVE GRID */}
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:h-full md:grid-cols-4 xl:grid-cols-3\2 gap-10 max-w-7xl mx-auto">
        {womenPrices.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={`${
                darkMode ? "bg-white/10 border border-gray-700" : "bg-pink-400/30 border border-gray-900"
