...
const ContactInfo = () => {
  ...
  return (
    <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-white text-black"} transition-colors`}>
      <div
        className={`container mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12 transition-colors duration-300`}
      >
        {/* Address */}
        <div>
        ...
        <div>
          ...
          <p
            className={`mt-3 ${darkMode ? "text-gray-300" : "text-gray-600"}`}
          >
            info@euphoriasalon.in
          </p>
          <p
            className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}
          >
            feedback@euphoriasalon.in
          </p>
        </div>
        ...
        <div>
          ...
          <div
            className={`mt-3 leading-relaxed space-y-1 ${
              darkMode ? "text-gray-300" : "text-gray-600"
            }`}
          >
