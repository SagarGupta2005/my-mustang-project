    ...
    <section className="relative select-none w-full h-screen overflow-hidden" >
      ...
      <div
        ...
        <button
          ...
          className="w-22 h-22 flex items-center justify-center text-white rounded-full relative overflow-hidden"
      ...
      <div className="absolute bottom-6 flex gap-3 w-full justify-center">
        {slides.map((_, i) => (
          ...
          onClick={() => setIndex(i)}
          className={`
            w-5 h-2 cursor-pointer transition-all duration-500
