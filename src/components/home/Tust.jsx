...
const Trust = () => {
  ...
  return (
    <motion.div
      className={`
        relative w-full flex-4 select-none items-center min-h-full py-20 px-6 md:px-16 lg:px-28 xl:px-30
    ...
    >
      ...
      <div className="relative z-10 mb-30 text-center">
        <h2
          className={`text-xl sm:text-2xl md:text-3xl font-semibold hover:underline ${
